...
model.compile(optimizer=tf.keras.optimizers.RMSprop(lr=learing_rate), loss=tf.keras.losses.sparse_categorical_crossentropy, metrics=['accuracy'])
...
...
       ...
       [9.7274762e-01, 2.7252322e-02]], dtype=float32)
